                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center">
                                ...
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> 500 에러가 발생하였습니다.</h4>
                                <form class="mt-5 mb-5">
                                    
                                    <div class="text-center mb-4 mt-4"><a href="http://localhost/store/" class="btn btn-primary">홈페이지로 돌아가기</a>
                                    </div>
                                </form>                               
                            </div>
                        </div>
