    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
        <div class="nk-sidebar" style="height: 600px;  width: 243px">         
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 col-xl-3" style="padding-left:0; height:1297px">
                        <div class="card">
                            <div class="card-body">
                                <div class="media align-items-center mb-4">
                                    <img class="mr-3" src="${app}/resources/quixlab/themes/quixlab/images/avatar/11.png" width="80" height="80" alt="">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media media-reply">
                                    <img class="mr-3 circle-rounded" src="${app}/resources/quixlab/themes/quixlab/images/avatar/2.jpg" width="50" height="50" alt="Generic placeholder image">
                                    <div class="media-body">
                                        ...
                                        <ul>
                                            <li class="d-inline-block"><img class="rounded" width="60" height="60" src="${app}/resources/quixlab/themes/quixlab/images/blog/2.jpg" alt=""></li>
                                            <li class="d-inline-block"><img class="rounded" width="60" height="60" src="${app}/resources/quixlab/themes/quixlab/images/blog/3.jpg" alt=""></li>
                                            <li class="d-inline-block"><img class="rounded" width="60" height="60" src="${app}/resources/quixlab/themes/quixlab/images/blog/4.jpg" alt=""></li>
                                            <li class="d-inline-block"><img class="rounded" width="60" height="60" src="${app}/resources/quixlab/themes/quixlab/images/blog/1.jpg" alt=""></li>
                                        </ul>

                                        <div class="media mt-3">
                                        <img class="mr-3 circle-rounded circle-rounded" src="${app}/resources/quixlab/themes/quixlab/images/avatar/4.jpg" width="50" height="50" alt="Generic placeholder image">
                                        <div class="media-body">
                                            <div class="d-sm-flex justify-content-between mb-2">
                                                <h5 class="mb-sm-0">Milan Gbah <small class="text-muted ml-3">about 3 days ago</small></h5>
                                                <div class="media-reply__link">
