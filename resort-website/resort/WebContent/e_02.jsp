	...
	<body>
		...
		<table cellspacing=1 width=600 border=1>
			...
			<tr style="background-color:#ffffff">
				<td width=30 height=50><p align=center><%=gongjiList.get(i).getId()%></p></td>
   				<%
   				if(gongjiList.get(i).getDate().equals(today)) {
   					%>
				<td width=200 height=50><p align=left>
				<a href=e_02_view.jsp?key=<%=gongjiList.get(i).getId()%>><%=gongjiList.get(i).getTitle()%>[NEW]</a></p></td>				
				<%
   				} else {
   					%>
   					
						<td width=130 height=50><p align=left>
				...
				<a href=e_02_view.jsp?key=<%=gongjiList.get(i).getId()%>><%=gongjiList.get(i).getTitle()%></a></p></td>		
   				...
   				%>
   					...
   					%>	
						<td width=40 height=50><p align=center></p></td>
					<% 	
						} else if(gongjiList.get(i).getFile() != null) {
							%>
							<td width=40 height=50 align=center><img src=./img/file.PNG width=30 height=30></td>
							<% 
						}
   						
   					%>
				<td width=50 height=50><p align=center><%=gongjiList.get(i).getViewcnt()%></p></td>
				<td width=70 height=50><p align=center><%=gongjiList.get(i).getDate()%></p></td>
			</tr>
			<%            
	   				}
   			...
   			%>
   			<tr style="background-color:#ffffff;">
				<td width=30 height=50><p align=center><%=gongji_fList.get(i).getId()%></p></td>
				<%
				...
				<%
   				...
   				<%
					...
					<% 	
							...
							%>
							<td width=40 height=50 align=center><img src=./img/file.PNG width=30 height=20></td>
							<% 
						}
   						
   					%>
				<td width=50 height=50><p align=center><%=gongji_fList.get(i).getViewcnt()%></p></td>
				<td width=70 height=50><p align=center><%=gongji_fList.get(i).getDate()%></p></td>
			</tr>
			<%
