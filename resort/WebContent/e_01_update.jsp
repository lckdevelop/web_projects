...
<html>
		...
		<title>글 보기</title>
			<script LANGUAGE=JavaScript>
				function submitForm(mode) {
					if(mode == "write") {
						updateWrite.action = "e_01_write.jsp?key=update";
						//viewWrite.submit();
					} else if(mode == "delete") {
						updateWrite.action = "e_01_delete.jsp";
					}
					updateWrite.submit();
				}
			</script>
	...
	<body>
		...
		%>
		<form method=post name=updateWrite>
			<div align=center>
				<table width=650 border=1 cellspacing=0 cellpadding=5>
					...
					<tr>
						...
						<td bgcolor=#ffffff><input type=text name=title value=<%=title%> size=70 maxlength=70></td>
					</tr>
					<tr>
