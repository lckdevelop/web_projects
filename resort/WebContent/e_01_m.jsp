	...
	<body>
		...
		<table cellspacing=1 border=1>
			...
			<tr style="background-color:#ffffff;">
				<td><p align=center><%=gongjiList.get(i).getId()%></p></td>
   				<%
				...
				<a href=e_01_view.jsp?key=<%=gongjiList.get(i).getId()%>><%=gongjiList.get(i).getTitle()%></a></p></td>		
   				...
   				%>
					...
					<% 	
							...
							%>
							<td><img src=file.PNG width=20 height=10 align=center><p align=center></p></td>
							<% 
						}
   						
   					%>
				<td><p align=center><%=gongjiList.get(i).getViewcnt()%></p></td>
				<td><p align=center><%=gongjiList.get(i).getDate()%></p></td>
			</tr>
			<%            
	   				}
   			...
   			%>
   			<tr style="background-color:#ffffff;">
				<td><p align=center><%=gongji_fList.get(i).getId()%></p></td>
				<%
				...
				<%
   				...
   				<%
					...
					<% 	
   					...
   					%>
				<td><p align=center><%=gongji_fList.get(i).getViewcnt()%></p></td>
				<td><p align=center><%=gongji_fList.get(i).getDate()%></p></td>
			</tr>
			<%
		...
		<form mehtod=post action=e_01_insert.jsp enctype=multipart/form-data>
			...
			<!--select태그에서의 value값은 전송되는 값을 지정하는 것이다. 보여지는 값이 아니다 -->
      				<select name="sel" class="selectpicker">
